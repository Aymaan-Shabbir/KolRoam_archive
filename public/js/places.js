...
function toggleCategoryDisplay(category) {
    ...
    if (categorySection.style.display === 'none' || getComputedStyle(categorySection).display === 'none') {
      ...
      categorySection.style.display = 'none';
          ...
          function toggleMap(cardNumber) {
            ...
            if (mapContainer.style.display === 'none' || getComputedStyle(mapContainer).display === 'none') {
              // Show the map container
              mapContainer.style.display = 'block';
             
              
              
              document.querySelector(`[data-card-number="${cardNumber}"] .toggle-map-btn`).innerText = 'Hide Map';
            } else {
              // Hide the map container
              mapContainer.style.display = 'none';
             
              document.querySelector(`[data-card-number="${cardNumber}"] .toggle-map-btn`).innerText = 'Show Map';
            }
          }
